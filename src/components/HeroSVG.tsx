  ...
  return (
    <>
      <div
        dangerouslySetInnerHTML={{
          __html: `<svg
      class="hidden lg:block absolute h-full w-full object-cover inset-0"
      width="1920"
      height="929"
    ...
    >
      <g id="hero-background-desktop">
        <g
          id="background"
          style="transform: translate3d(0%, 0.33%, 0px); --motion-translateX: 0px; --motion-translateY: 0px; transition: transform 500ms cubic-bezier(0.25, 0.46, 0.45, 0.94);"
        >
        ...
        <g
          id="foreground"
          style="transform: translate3d(-0.289286%, -0.217143%, 0px); --motion-translateX: 0px; --motion-translateY: 0px; opacity: 1; transition: transform 500ms cubic-bezier(0.25, 0.46, 0.45, 0.94);"
        >
          <path
            id="Vector_13"
      ...
      >
        <g id="hero-background-desktop">
          <g
            id="background"
            // stylee="--motion-translateX: 0px; --motion-translateY: 0px;"
            style={{
              transform: "translate3d(0%, 0.33%, 0px)",
              transition:
          ...
          <g
            id="foreground"
            // style="--motion-translateX: 0px; --motion-translateY: 0px; "
            style={{
              transform: "translate3d(-0.289286%, -0.217143%, 0px)",
              opacity: 1,
              transition:
                "transform 500ms cubic-bezier(0.25, 0.46, 0.45, 0.94)",
            }}
